...
function _custom_meta_boxes() {
  ...
  $staff = array(
    ...
    'fields'      => array(
      ...
      array(
        'label'       => 'Link',
        'id'          => 'magicreche_staff_link',
        'type'        => 'text',
        'desc'        => 'Optional URL if you want to have a detailed description on some page.',
        'std'         => '',
        'rows'        => '',
        'post_type'   => '',
        'taxonomy'    => '',
  ...
  $page = array(
    ...
    'fields'      => array(
      ...
      array(
        ...
        'id'          => 'magicreche-title-background',
        'type'        => 'background',
        'desc'        => 'For traditional separate pages. Does not work for section pages.',
      ),
      array(
        'label'       => 'Sub Title',
        'id'          => 'magicreche-sub-title',
        'type'        => 'text',
        'desc'        => 'Works only on section pages.',
        'std'         => '',
        'rows'        => '',
        'post_type'   => '',
        'taxonomy'    => '',
  ...
  $page_map = array(
    ...
    'fields'      => array(
      ...
      array(
        ...
        'settings'    => array(
          array(
            'label'       => 'Latitude (find at <a href="http://www.latlong.net/">http://www.latlong.net/</a>)',
          ...
          array(
            'label'       => 'Longitude (find at <a href="http://www.latlong.net/">http://www.latlong.net/</a>)',
  ...
  $post_audio = array(
    ...
    'fields'      => array(
      array(
        'label'       => 'Audio URL (oEmbed) or Embed Code',
  ...
  $post_video = array(
    ...
    'fields'      => array(
      array(
        'label'       => 'Video URL (oEmbed) or Embed Code',
  ...
  if ( !empty($post_id) )  { 
    ...
    // If blog post
    if( 'gallery' == get_post_format($post_id) ) ot_register_meta_box( $post_gallery );
    if( 'audio' == get_post_format($post_id) ) ot_register_meta_box( $post_audio );
    if( 'video' == get_post_format($post_id) ) ot_register_meta_box( $post_video );
