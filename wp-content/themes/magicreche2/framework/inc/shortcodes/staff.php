	...
	if( have_posts() ) :
		...
		while ( have_posts() ) : the_post();
			...
			if( $layout == 'carousel' ) {
				...
				$link = get_post_meta( $post_id, 'magicreche_staff_link', true );
				...
				if (has_post_thumbnail()) {
					if ( !empty($link) ) $return .= '<a href="' . $link . '">';
						$return .= get_the_post_thumbnail($post_id, 'staff');
					if ( !empty($link) ) $return .= '</a>';
				}

				if ( !empty($link) && !empty($name) ) {
					$return .= '<h4><a href="' . $link . '">' . $name . '</a></h4>';
				} elseif ( !empty($name) ) {
					$return .= '<h4>' . $name . '</h4>';
				}
				...
				if( !empty($facebook) || !empty($twitter) || !empty($google) || !empty($linkedin) || !empty($flickr) || !empty($pinterest) || !empty($instagram) || !empty($vimeo) || !empty($youtube) || !empty($email) ) {
					$return .= '<p>';
						if( !empty($facebook) ) $return .= ' <a href="' . $facebook . '" target="_blank"><i class="fa fa-facebook-square fa-lg"></i></a> ';
						if( !empty($twitter) ) $return .= ' <a href="' . $twitter . '" target="_blank"><i class="fa fa-twitter-square fa-lg"></i></a> ';
						if( !empty($google) ) $return .= ' <a href="' . $google . '" target="_blank"><i class="fa fa-google-plus-square fa-lg"></i></a> ';
						if( !empty($linkedin) ) $return .= ' <a href="' . $linkedin . '" target="_blank"><i class="fa fa-linkedin-square fa-lg"></i></a> ';
						if( !empty($flickr) ) $return .= ' <a href="' . $flickr . '" target="_blank"><i class="fa fa-flickr fa-lg"></i></a> ';
						if( !empty($pinterest) ) $return .= ' <a href="' . $pinterest . '" target="_blank"><i class="fa fa-pinterest-square fa-lg"></i></a> ';
						if( !empty($instagram) ) $return .= ' <a href="' . $instagram . '" target="_blank"><i class="fa fa-instagram fa-lg"></i></a> ';
						if( !empty($vimeo) ) $return .= ' <a href="' . $vimeo . '" target="_blank"><i class="fa fa-vimeo-square fa-lg"></i></a> ';
						if( !empty($youtube) ) $return .= ' <a href="' . $youtube . '" target="_blank"><i class="fa fa-youtube-square fa-lg"></i></a> ';
						if( !empty($email) ) $return .= ' <a href="mailto:' . $email . '" target="_blank"><i class="fa fa-envelope fa-lg"></i></a> ';
					$return .= '</p>';
				}
