...
if( !empty( $min_height ) )  $style = ' style="min-height:' . $min_height . '"';
...
?><section id="<?php echo esc_attr(getMagicrechePageID($section_page->ID)); ?>" class="<?php echo implode(" ", $css_classes); ?>"<?php echo $style; ?>><?php
	...
	if( $slides_count > 1 ) { ?>
		<div class="superslides" data-width="#<?php echo esc_attr(getMagicrechePageID($section_page->ID)); ?>" data-height="#<?php echo esc_attr(getMagicrechePageID($section_page->ID)); ?>" data-pause="<?php echo $pause; ?>" data-animation="<?php echo $animation; ?>" data-effect="<?php echo $effect; ?>">
